...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Salva os produtos p1, p2 e p3 no banco
// O Hibernate automaticamente insere os produtos na tabela tb_product
// e popula tb_product_category com os pares (product_id, category_id)
        productRepository.saveAll(Arrays.asList(p1, p2, p3));
    }
}